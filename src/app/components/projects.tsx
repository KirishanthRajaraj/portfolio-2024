...
const projects = () => {
    return (
        <div className="container mx-auto px-[25px] py-20 relative">
            ...
            <h2 className="text-5xl font-black mb-24 -mt-12 before:content-[''] before:absolute before:border-b-[18px] before:border-b-green before:w-[14rem] before:left-[3.5rem] before:top-[4.3rem] before:-z-10">Projects</h2>
            ...
            <div className="flex gap-16 flex-col lg:flex-row">
                ...
                <div className="content w-full xl:w-[40%] lg:w-[40%]">
                    ...
                    <div className="lead text-xl font-semibold ">
